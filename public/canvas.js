...
S.UI = (function () {
    ...
    function getValue (value) {
        console.warn(value && value.split(' ')[1], '118')
        return value && value.split(' ')[1];
    }

    function getSrc (value) {
        console.warn('sssss')
        console.warn(value && value.split(' '))
        return value && value.split(' ')[1];
    }

    function getAction (value) {
        value = value && value.split(' ')[0];
        console.warn(value, 'getAction')
    ...
    function performAction (value) {
        ...
        timedAction(function (index) {
            ...
            console.warn(action)
            value = action === 'image' ? getSrc(current) : getValue(current);
            ...
            case 'image':
                ...
                // value = Math.min(value, maxShapeSize);
                console.warn('???')
                S.ShapeBuilder.imageFile(value, S.Shape.switchShape);
                break;
    ...
    function init () {
        bindEvents();
        input.focus();
        isTouch && document.querySelector('.body').classList.add('touch');
    }
